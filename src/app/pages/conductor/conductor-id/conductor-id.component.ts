...
@Component({
  selector: 'app-conductor-id',
  templateUrl: './conductor-id.component.html',
  styleUrls: ['./conductor-id.component.css']
})
export class ConductorIdComponent implements OnInit {
